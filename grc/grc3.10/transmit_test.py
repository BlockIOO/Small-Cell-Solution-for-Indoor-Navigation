...
class transmit_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "transmit_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("transmit_test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmit_test")
        ...
        self.gain = gain = 1
        self.center_freq = center_freq = 1.9e9
        ...
        self._center_freq_range = qtgui.Range(1.8e9, 2e9, 1e8, 1.9e9, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(44000, analog.GR_COS_WAVE, 261, 1, 0, 0)
...
def main(top_block_cls=transmit_test, options=None):
