...
class Printer:
    ...
    def drawNetwork(self, filename, BS=True, UE=True, links=True, obstacles=True, fillMethod="SINR", colorMap = None, drawLegend=True, tilesInLine = 100, figSize = (8, 8), colorMinValue = None, colorMaxValue = None, outputFileFormat = ["png"], obstacleVector = None):
        ...
        if fillMethod == "SINR":
            ...
            for x in range(0, tilesInLine):
                for y in range(0, tilesInLine):
                    ...
                    #ue.connectToTheBestBS(self.parent.bs, obstacleVector = obstacleVector)
                    #SINR = ue.calculateSINR(self.parent.bs, obstacleVector = obstacleVector)
        ...
        if BS == True:
            ...
            #ax.plot(bs_x_locations, bs_y_locations, 'r', color="black", markersize=10)
            ax.plot(bs_x_locations, bs_y_locations, 'r^', markersize=10)
        ...
        if UE == True:
            ...
            #ax.plot(ue_x_locations, ue_y_locations, 'b', color="black", markersize=10)
            ax.plot(ue_x_locations, ue_y_locations, 'b*', markersize=10)
