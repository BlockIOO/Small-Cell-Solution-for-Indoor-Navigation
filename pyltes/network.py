...
class CellularNetwork:
    ...
    def connectUsersToNearestBS(self, obstacleVector = None):
        for ue in self.ue:
            ue.connectToNearestBS(self.bs)

    def connectUsersToTheBestBS(self, obstacleVector = None):
        for ue in self.ue:
            ue.connectToTheBestBS(self.bs, obstacleVector)
